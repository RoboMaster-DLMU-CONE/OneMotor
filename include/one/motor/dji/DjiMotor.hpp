...
namespace one::motor::dji
{
    ...
    public:
        ...
        {
            m_pos_ref.store(ref.numerical_value_in(rad),
        ...
        {
            m_ang_ref.store(ref.numerical_value_in(rad / s),
                            std::memory_order_release);
        };
        ...
        {
            m_tor_ref.store(ref.numerical_value_in(N * m),
                            std::memory_order_release);
        };
        ...
        {
            m_pos_ref.store(pos_ref.numerical_value_in(rad),
                            std::memory_order_release);
            m_ang_ref.store(ang_ref.numerical_value_in(rad / s),
                            std::memory_order_release);
            m_tor_ref.store(tor_ref.numerical_value_in(N * m),
                            std::memory_order_release);
        };
